				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-4 col-md-6 mb-30">
							<div class="project-item">
							    <div class="project-img">
							        <a href="portfolios-single.html"><img src="<?= base_url(''); ?>assets/reno/images/project/style1/1.jpg" alt="images"></a>
							    </div>
						...
						<div class="col-lg-4 col-md-6 mb-30">
							<div class="project-item">
							    <div class="project-img">
							        <a href="portfolios-single.html"><img src="<?= base_url(''); ?>assets/reno/images/project/style1/2.jpg" alt="images"></a>
							    </div>
							    <div class="project-content"> 
							        <div class="project-inner">
						...
						<div class="col-lg-4 col-md-6 mb-30">
							<div class="project-item">
							    <div class="project-img">
							        <a href="portfolios-single.html"><img src="<?= base_url(''); ?>assets/reno/images/project/style1/3.jpg" alt="images"></a>
							    </div>
							    <div class="project-content"> 
							        <div class="project-inner">
