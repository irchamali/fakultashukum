...
<body class="page-header-fixed compact-menu pace-done page-sidebar-fixed">
                                    ...
                                    <table id="data-table" class="display table" style="width: 100%; ">
                                        ...
                                        <tbody id="body-table">
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?= $no; ?></td>
                                                    <td><?= $row['pudoscategory_name']; ?></td>
                                                    <td><?= $row['pudoscategory_slug']; ?></td>
                                                    <td style="text-align: center;">
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-edit" data-id="<?= $row['pudoscategory_id']; ?>" data-category="<?= $row['pudoscategory_name']; ?>"><span class="fa fa-pencil"></span></a>
                                                        <a href="javascript:void(0);" class="btn btn-xs btn-delete" data-id="<?= $row['pudoscategory_id']; ?>"><span class="fa fa-trash"></span></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
    ...
    <!--ADD RECORD MODAL-->
    <form action="/<?= session('role'); ?>/pudoscategory" method="POST">
