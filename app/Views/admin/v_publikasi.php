...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
                                        ...
                                        <tbody id="body-table">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle;"><?= $row['pudos_title']; ?>
                                                    </td>
                                                    <td style="vertical-align: middle;"><?= $row['pudos_name']; ?>
                                                    </td>
                                                    <td style="vertical-align: middle;"><a href="<?= $row['pudos_link']; ?>"><?= $row['pudos_publisher']; ?></a>
                                                    </td>
                                                    <td style="vertical-align: middle;"><?= $row['pudos_year']; ?>
                                                    </td>
                                                    
                                                    <td style="vertical-align: middle;"><?= $row['pudos_category_id']; ?>
                                                    </td>
                                                    <td style="vertical-align: middle;">
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                                <li><a href="javascript:void(0);" data-toggle="modal" data-target="#ModalEdit<?= $row['pudos_id']; ?>"><span class="icon-pencil"></span> Edit</a></li>
                                                                <li><a href="javascript:void(0);" class="delete" data-userid="<?= $row['pudos_id']; ?>"><span class="icon-trash"></span> Delete</a></li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                </tr>
                                    ...
                                    <select class="form-control" name="category" required>
                                        <option value="">-Category Option-</option>
                                            <?php foreach ($categories as $row) : ?>
                                                <option value="<?= $row['pudoscategory_id']; ?>"><?= $row['pudoscategory_name']; ?></option>
                                            <?php endforeach; ?>
                                    </select>
                                </div>
    ...
    ?>
        ...
        <form id="add-row-form" action="/<?= session('role'); ?>/publikasi" method="post" enctype="multipart/form-data">
            ...
            <div class="modal fade" id="ModalEdit<?= $row['pudos_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="publisher" value="<?= $row['pudos_publisher']; ?>" class="form-control" placeholder="Nama publisher" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="year" value="<?= $row['pudos_year']; ?>" class="form-control" placeholder="Tahun Pembuatan YYYY" required>
                                    </div>
                                    <div class="form-group">
                                        <textarea name="link" class="form-control" rows="2" placeholder="Share Link Google Drive" required><?= $row['pudos_link']; ?></textarea>
                                    </div>
                                    
                                    <select name="category" class="form-control">
                                        <option value="">-Select Category-</option>
                                        <?php foreach($categories as $erow): ?>
                                        <option value="<?= $erow['pudoscategory_id']; ?>" <?= ($row['pudos_category_id'] == $erow['pudoscategory_id'])?'selected': '' ?>><?= $erow['pudoscategory_name']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    </div>
                            ...
                            <div class="modal-footer">
                            <input type="hidden" name="pudos_id" value="<?= $row['pudos_id']; ?>" required>
                                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
